  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      <div>
        ...
        <p className='my-6 text-[15px] text-gray-500 '>EraseBack instantly erases image backgrounds with precision and speed. No design skills needed —<br className='max-sm:hidden'/> just upload, click, and download your perfect image.</p>
        <Link to='/image'>
        <div>
